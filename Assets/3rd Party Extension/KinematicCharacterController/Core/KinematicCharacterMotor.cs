...
#pragma warning restore 0649
        ...
        /// <summary>
        /// Is the character grounded, and not ungrounding this update?
        /// </summary>
        public bool IsGroundedThisUpdate { get { return GroundingStatus.IsStableOnGround && !MustUnground(); } }
        /// <summary>
...
#pragma warning restore 0414 
        ...
        #region SelfAdded
        private Vector3 EffectiveGroundNormal = Vector3.zero;
        /// <summary>
        /// Returns what would generally be considered the Effective Ground Normal
        /// Self added Code
        /// </summary>
        ...
        private void SetEffectiveGroundNormal()
        {
            ...
            EffectiveGroundNormal = GroundingStatus.GroundNormal;
            
            if(stabilityReport.LedgeDetected)
            {
                EffectiveGroundNormal = stabilityReport.LedgeGroundNormal;
            }
            else if (BaseVelocity.magnitude > 0f && GroundingStatus.SnappingPrevented)
            {
