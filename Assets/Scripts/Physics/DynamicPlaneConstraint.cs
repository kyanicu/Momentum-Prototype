...
public interface IDynamicPlaneConstrainable
{
    ...
    bool reaffirmCurrentPlane { get; }
}

[RequireComponent(typeof(IDynamicPlaneConstrainable))]
...
#region Dynamic Plane Info
    ...
    void Start()
    {
        ...
        SetCurrentPlane(new Plane(transform.forward, constrainable.position));
    }
    ...
    private void ReaffirmCurrentPlane()
    {
